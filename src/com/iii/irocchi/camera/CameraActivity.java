...
public class CameraActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// add flag
		ImageView btnFlagCamera = (ImageView) findViewById(R.id.btnFlagCamera);
		if (CommonInfor.getCountryFlag(getApplicationContext(),
				CommonInfor.countryName) != null) {
			btnFlagCamera.setImageBitmap(CommonInfor.getCountryFlag(
					getApplicationContext(), CommonInfor.countryName));
		}
		if (CommonInfor.countryName != "") {
			TextView textView = (TextView) findViewById(R.id.txtCountryNameCamera);

			textView.setText(CommonInfor.countryName);
		}
		if (ShowMap_Activity.sex == 0) {
			ImageView btnSexCamera = (ImageView) findViewById(R.id.btnSexCamera);
			btnSexCamera.setImageResource(R.drawable.temp_thumbnail_mimirin);
		}
		// -----------------------------------------------------------------//
		...
		/*---------------- Chá»¥p vÃ  lÆ°u áº£nh ----------------------*/
		mTakePicture = (ImageView) findViewById(R.id.button_capture);
		mTakePicture.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				System.out.println("THUAN        Lllllllllllllllllll");
		...
		imgBBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intentBack = new Intent(CameraActivity.this,
	...
	public void setFrameIrocchi() {
		...
		ImageView imgViewSmallI = (ImageView) findViewById(R.id.smallIrocchi);
		switch (key) {
		case 1:

			imagePreview.setImageResource(R.drawable.normal_akacchi2);
			imgViewSmallI.setImageResource(R.drawable.temp_icon_irocchi2);
			break;
		case 2:
			imagePreview.setImageResource(R.drawable.normal_akacchi3);
			imgViewSmallI.setImageResource(R.drawable.temp_icon_irocchi3);
			break;
		case 3:
			imagePreview.setImageResource(R.drawable.normal_akacchi1);
			imgViewSmallI.setImageResource(R.drawable.temp_icon_irocchi1);
			break;
		case 4:
			imagePreview.setImageResource(R.drawable.normal_akacchi4);
			imgViewSmallI.setImageResource(R.drawable.temp_icon_irocchi4);
			break;
		default:
			break;
		}
	...
	private void showPreview(final byte[] data) {
		new AsyncTask<Void, Void, Long>() {
			...
			protected void onPostExecute(Long result) {
				...
				Intent intents2 = new Intent(CameraActivity.this,
						CropActivity.class);
		...
		try {
			...
			if (rotation == 0) {
				if (mCurentCamId == 0)
					...
					mScreenRotation = (camInfo.orientation) % 360;// reverse
																	// camera
																	// here
	...
	private File getOutputMediaFile() {
		...
		pictureFile = new File(mediaStorageDir.getPath() + File.separator
				+ Main_Irocchi_Activity.myAcc.getUser_Name() + timeStamp
				+ ".jpg");
		return pictureFile;
	}
